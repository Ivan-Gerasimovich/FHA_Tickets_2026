...
#property()[\
  Если $V, U, W$ --- линейные пр-ва над одним и тем же полем $P$, \ $f: V -> U$ --- линейное отображение, \  $g: U -> W$ --- линейное отображение, то \ #rect[$g compose f: V -> W$ --- линейное отображение.]
]
